...
export default function BeforeAfterSlider() {
  ...
  return (
    <section id="before-after" className="relative w-full py-20 px-4 sm:px-6 lg:px-8 bg-synthwave-dark overflow-hidden">
      <div className="max-w-[100rem] mx-auto">
        {/* Background Elements */}
        <motion.div
          className="absolute bottom-0 right-0 w-96 h-96 bg-synthwave-neon-pink/10 rounded-full blur-3xl"
          animate={{ y: [0, -50, 0] }}
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-synthwave-neon-pink/30 to-synthwave-dark flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="font-heading text-2xl font-bold text-synthwave-neon-pink">BEFORE</p>
                <p className="font-paragraph text-sm text-synthwave-light/60 mt-2">Dull, damaged edge</p>
              </div>
            </div>
            ...
            >
              <div className="text-center w-full">
                <div className="text-6xl mb-4">✨</div>
                <p className="font-heading text-2xl font-bold text-synthwave-neon-cyan">AFTER</p>
                <p className="font-paragraph text-sm text-synthwave-light/60 mt-2">Factory-fresh edge</p>
              </div>
            </motion.div>
            ...
            >
              <motion.div
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-gradient-to-r from-synthwave-neon-pink to-synthwave-neon-cyan rounded-full shadow-lg flex items-center justify-center"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-synthwave-midnight/50 border border-synthwave-neon-pink/30 rounded-lg p-6"
            >
              <h3 className="font-heading text-lg font-bold text-synthwave-neon-pink mb-4">
                BEFORE: THE PROBLEM
              </h3>
              <ul className="space-y-2 font-paragraph text-synthwave-light/70 text-sm">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-synthwave-midnight/50 border border-synthwave-neon-cyan/30 rounded-lg p-6"
            >
              <h3 className="font-heading text-lg font-bold text-synthwave-neon-cyan mb-4">
                AFTER: THE SOLUTION
              </h3>
              <ul className="space-y-2 font-paragraph text-synthwave-light/70 text-sm">
