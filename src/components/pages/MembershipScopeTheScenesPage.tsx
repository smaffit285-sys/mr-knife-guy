...
export default function MembershipScopeTheScenesPage() {
  const perks = [
    { text: 'Up to 10 knives per month', color: 'bg-blue-500' },
    { text: 'Basic sharpening service', color: 'bg-blue-500' },
    { text: 'Email support', color: 'bg-blue-500' },
    { text: 'Monthly newsletter', color: 'bg-blue-500' },
    { text: 'Access to community forum', color: 'bg-blue-500' },
  ];

  const pricingTiers = [
    { pieces: '1-5 knives', price: '$25', description: 'Single blade sharpening' },
    { pieces: '6-10 knives', price: '$40', description: 'Multi-blade package' },
  ];
      ...
      <main className="flex-1 w-full max-w-[100rem] mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="font-paragraph text-xl text-synthwave-light">
            Your entry point to the Miami Knife Club experience
          </p>
        </motion.div>
              ...
              {pricingTiers.map((tier, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="bg-blue-500 w-3 h-3 rounded-full mt-2 flex-shrink-0" />
